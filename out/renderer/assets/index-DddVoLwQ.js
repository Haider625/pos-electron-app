...
//#endregion
//#region src/renderer/services/auth.service.ts
var import_client = require_client();
var authService = { login: async (credentials) => {
...
//#endregion
//#region src/renderer/hooks/useAuth.tsx
...
//#endregion
//#region src/renderer/services/products.service.ts
var productsService = {
	getAll: async () => {
...
//#endregion
//#region src/renderer/hooks/useProducts.ts
...
//#endregion
//#region src/renderer/services/categories.service.ts
var categoriesService = {
	...
	update: async (id, name) => {
		return await window.api.categories.update({
			id,
			name
		});
	},
...
//#endregion
//#region src/renderer/hooks/useCategories.ts
...
//#endregion
//#region src/renderer/services/subCategories.service.ts
var subCategoriesService = {
	getAll: async () => {
		return await window.api.subCategories.getAll();
	},
	create: async (name, categoryId) => {
		return await window.api.subCategories.create({
			name,
			categoryId
		});
	},
...
//#endregion
//#region src/renderer/hooks/useSubCategories.ts
function useSubCategories() {
	...
	const loadData = (0, import_react.useCallback)(async () => {
		...
		setError(null);
		try {
			setSubCategories(await subCategoriesService.getAll());
		} catch (err) {
...
//#endregion
//#region src/renderer/services/brands.service.ts
var brandsService = {
	getAll: async () => {
	...
	update: async (id, name) => {
		return await window.api.brands.update({
			id,
			name
		});
	},
...
//#endregion
//#region src/renderer/hooks/useBrands.ts
function useBrands() {
	const [brands, setBrands] = (0, import_react.useState)([]);
	const [loading, setLoading] = (0, import_react.useState)(false);
	const [error, setError] = (0, import_react.useState)(null);
	const loadBrands = (0, import_react.useCallback)(async () => {
		setLoading(true);
		try {
			setBrands(await brandsService.getAll());
		} catch (err) {
...
//#endregion
//#region src/renderer/pages/Products/TopBar.tsx
function TopBar({ onAdd, searchTerm, onSearchChange, totalCount, resultsCount, activeFiltersCount, onResetFilters }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [activeFiltersCount > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "إضافة منتج" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					style: {
						fontSize: "18px",
						lineHeight: 1
					},
...
//#endregion
//#region src/renderer/pages/Products/FilterSidebar.tsx
function FilterSidebar({ categories, subCategories, brands, filters, onFilterChange }) {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
						...
						style: { color: "#0f172a" },
						children: "الكل"
					}), subCategories.map((cat) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
						value: cat.id,
						style: { color: "#0f172a" },
						children: cat.name
					}, cat.id))]
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							type: "number",
							placeholder: "إلى",
							value: filters.priceRange[1] || 1e6,
...
//#endregion
//#region src/renderer/pages/Products/ProductGrid.tsx
function ProductGrid({ products, loading, selectedId, onSelect, onEdit, onDelete, onShowHistory }) {
	...
	if (loading && products.length === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		style: {
			display: "flex",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("th", {
						...
						children: ["المنتج ", sortConfig?.key === "name" ? sortConfig.direction === "asc" ? "↑" : "↓" : ""]
					}),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("th", {
						...
						children: ["السعر ", sortConfig?.key === "price" ? sortConfig.direction === "asc" ? "↑" : "↓" : ""]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("th", {
						...
						children: ["المخزون ", sortConfig?.key === "stock" ? sortConfig.direction === "asc" ? "↑" : "↓" : ""]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
						style: {
							padding: "10px 16px",
			...
			}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tbody", { children: [sortedProducts.map((p) => {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									children: p.unit === "piece" ? "حبة" : p.unit
								})]
							})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							...
							children: p.stock === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								style: {
								...
								children: "نافد"
							}) : p.stock <= (p.reorderLevel || 5) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								style: {
									display: "inline-block",
									padding: "4px 12px",
									background: "#fef9c3",
			...
			}), sortedProducts.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
				colSpan: 6,
				style: {
					padding: "40px",
					textAlign: "center",
				...
				children: "لا توجد منتجات تطابق البحث والفلاتر"
			}) })] })]
		})
	});
}
//#endregion
//#region src/renderer/pages/Products/DetailsPanel.tsx
function DetailsPanel({ product, onClose, onEdit }) {
	const profitMargin = product.price && product.costPrice ? (product.price - product.costPrice) / product.price * 100 : 0;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		style: {
			width: "400px",
			background: "white",
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										style: { fontWeight: "bold" },
										children: ["$", (product.costPrice || 0).toFixed(2)]
									})]
								}),
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										style: {
											fontWeight: "bold",
											color: profitMargin > 15 ? "#38a169" : "#d69e2e"
										},
										children: [profitMargin.toFixed(2), "%"]
									})]
								})
							]
						})]
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									style: {
										fontSize: "18px",
										fontWeight: "bold",
										color: product.stock > 0 ? "#1a202c" : "#e53e3e"
									},
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: product.unit === "piece" ? "حبة" : product.unit
								})]
							})]
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: product.updatedAt ? new Date(product.updatedAt).toLocaleDateString("ar-EG") : "---"
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								display: "flex",
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: product.status === "active" ? "نشط في البيع" : "متوقف"
							})]
						})]
					})
				]
...
//#endregion
//#region src/renderer/services/units.service.ts
var unitsService = {
	getAll: async () => {
		return await window.api.units.getAll();
	},
	create: async (name, shortName) => {
		return await window.api.units.create({
			name,
			shortName
		});
	},
...
//#endregion
//#region src/renderer/hooks/useUnits.ts
function useUnits() {
	...
	const createUnit = async (name, shortName) => {
		try {
...
//#endregion
//#region src/renderer/pages/Products/ProductFormModal.tsx
function ProductFormModal({ product, categories, subCategories, brands, onClose, onSubmit }) {
	...
	const [isAdvancedOpen, setIsAdvancedOpen] = (0, import_react.useState)(false);
	...
	(0, import_react.useEffect)(() => {
		if (product) setFormData({ ...product });
			...
			const fetchNextSku = async () => {
				try {
					const nextSku = await window.api.products.getNextSku();
					setFormData((prev) => ({
						...prev,
						sku: nextSku
					}));
	...
	const updateField = (field, value) => {
		setFormData((prev) => {
			...
			if (field === "categoryId") newData.subCategoryId = void 0;
			return newData;
		});
	};
	const handleSave = async (e, addNew = false) => {
		e.preventDefault();
		setIsLoading(true);
		try {
			if (product) await onSubmit(product.id, formData);
	...
	const handleClose = () => {
		if (isDirty) {
			if (window.confirm("لديك تغييرات غير محفوظة، هل أنت متأكد من الإغلاق؟")) onClose();
		} else onClose();
	};
	const profit = (formData.price || 0) - (formData.costPrice || 0);
	const margin = formData.price ? (profit / formData.price * 100).toFixed(1) : 0;
	const filteredSubCategories = formData.categoryId ? subCategories.filter((sc) => sc.categoryId === formData.categoryId) : [];
	const labelStyle = {
		display: "block",
		marginBottom: "4px",
		fontWeight: "600",
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					children: product ? "تعديل المنتج" : "إضافة منتج جديد"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					style: {
						margin: "4px 0 0",
						fontSize: "12px",
					...
					children: "أدخل تفاصيل المنتج بدقة لإضافته إلى المخزون"
				})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					onClick: handleClose,
					style: {
						background: "#edf2f7",
				...
				children: [
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
										...
										style: { color: "#4a5568" },
										children: "-- اختر --"
									}), filteredSubCategories.map((sc) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
										value: sc.id,
										style: { color: "#1a202c" },
										children: sc.name
									}, sc.id))]
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
									...
									onChange: (e) => updateField("brandId", e.target.value ? Number(e.target.value) : null),
									style: {
										...inputStyle,
										background: "white",
										color: "#1a202c"
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
									style: labelStyle,
									children: ["سعر البيع ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										style: { color: "#e53e3e" },
										children: "*"
									})]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
										...
										required: true
									}), profit !== 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										style: {
											position: "absolute",
											left: 0,
											top: "40px",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
										...
										style: { color: "#4a5568" },
										children: "-- اختر --"
									}), units.map((u) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
										value: u.id,
										style: { color: "#1a202c" },
										children: u.shortName ? `${u.name} (${u.shortName})` : u.name
									}, u.id))]
								})] })
							]
						})]
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
										...
										title: "سيظهر تنبيه عند وصول المخزون لهذا الرقم"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										style: {
											fontSize: "10px",
										...
										children: "تنبيه عند الوصول لهذا الرقم"
									})
								] }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
									style: labelStyle,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							children: isAdvancedOpen ? "▼ خيارات متقدمة" : "▶ خيارات متقدمة (الضريبة، الخصم، الحالة)"
						})
					}),
					isAdvancedOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						style: {
							background: "#f8fafc",
							padding: "16px",
							borderRadius: "8px",
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									children: "نسبة مضافة على السعر النهائي"
								})
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
								style: labelStyle,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								...
								children: isLoading ? "جاري الحفظ..." : product ? "حفظ التعديلات" : "إضافة المنتج"
							}),
							!product && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
...
//#endregion
//#region src/renderer/pages/Products/StockHistoryModal.tsx
function StockHistoryModal({ isOpen, onClose, product, movements }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
				...
				}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: movements.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
					colSpan: 4,
					style: {
						padding: "30px",
						textAlign: "center",
					...
					children: "لا توجد حركات مسجلة لهذا المنتج"
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							...
							children: new Date(m.date).toLocaleString("ar-EG")
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							style: { padding: "12px" },
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: m.type === "in" ? "دخول" : m.type === "out" ? "خروج" : m.type === "adjustment" ? "تعديل" : "مرتجع"
							})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
							style: {
...
//#endregion
//#region src/renderer/pages/Products/ProductsPage.tsx
function ProductsPage() {
	...
	const [historyProduct, setHistoryProduct] = (0, import_react.useState)(null);
	const [movements, setMovements] = (0, import_react.useState)([]);
	const filteredProducts = (0, import_react.useMemo)(() => {
		return products.filter((p) => {
			const matchSearch = searchTerm === "" || p.name.toLowerCase().includes(searchTerm.toLowerCase()) || p.sku && p.sku.toLowerCase().includes(searchTerm.toLowerCase());
	...
	const handleShowHistory = async (product) => {
		try {
			setMovements(await window.api.products.getStockHistory(product.id));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TopBar, {
				...
				activeFiltersCount: (filters.categoryId !== null ? 1 : 0) + (filters.subCategoryId !== null ? 1 : 0) + (filters.brandId !== null ? 1 : 0) + (filters.stockStatus !== "all" ? 1 : 0) + (filters.priceRange[0] > 0 || filters.priceRange[1] < 1e6 ? 1 : 0),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				}), selectedProduct && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DetailsPanel, {
					product: selectedProduct,
					onClose: () => setSelectedProduct(null),
					onEdit: () => handleEditClick(selectedProduct)
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StockHistoryModal, {
				isOpen: showHistory,
				onClose: () => setShowHistory(false),
				product: historyProduct,
				movements
			}),
			isFormOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProductFormModal, {
...
//#endregion
//#region src/renderer/pages/Products.tsx
var Products_default = ProductsPage;
//#endregion
//#region src/renderer/pages/Categories.tsx
function CategoriesAndBrands() {
	...
	const { brands, createBrand, updateBrand, deleteBrand, loading: brandLoading } = useBrands();
	const [activeTab, setActiveTab] = (0, import_react.useState)("categories");
	...
	const [editingCatId, setEditingCatId] = (0, import_react.useState)(null);
	const [editCatName, setEditCatName] = (0, import_react.useState)("");
	const [newSubCatName, setNewSubCatName] = (0, import_react.useState)("");
	const [newBrandName, setNewBrandName] = (0, import_react.useState)("");
	const [editingBrandId, setEditingBrandId] = (0, import_react.useState)(null);
	const [editBrandName, setEditBrandName] = (0, import_react.useState)("");
	const activeCategory = (0, import_react.useMemo)(() => categories.find((c) => c.id === activeCategoryId), [categories, activeCategoryId]);
	const filteredSubCategories = (0, import_react.useMemo)(() => activeCategoryId ? subCategories.filter((s) => s.categoryId === activeCategoryId) : [], [subCategories, activeCategoryId]);
	...
	async function handleAddSubCategory(e) {
		...
		try {
			...
			alert("فشل في إضافة التصنيف الفرعي");
		}
	}
	...
	async function handleUpdateBrand(e) {
		e.preventDefault();
		if (!editBrandName.trim() || editingBrandId === null) return;
		try {
			await updateBrand(editingBrandId, editBrandName.trim());
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					children: "إدارة التصنيفات والماركات"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					style: {
						color: "#64748b",
						fontSize: "15px"
					},
					children: "نظّم منتجاتك وهيكلية متجرك بكل سهولة."
				})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					style: {
						background: "#f1f5f9",
						padding: "4px",
					...
					children: ["categories", "brands"].map((tab) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						children: tab === "categories" ? "التصنيفات" : "الماركات"
					}, tab))
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				style: { minHeight: "700px" },
				children: activeTab === "categories" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("aside", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: categories.map((cat) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									style: {
										...
										border: `1px solid ${activeCategoryId === cat.id ? "#bfdbfe" : "transparent"}`,
										boxShadow: activeCategoryId === cat.id ? "0 2px 4px rgba(59, 130, 246, 0.05)" : "none"
									},
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										style: {
											flex: 1,
										...
										children: editingCatId === cat.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
									...
									}), !editingCatId && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										style: {
											display: "flex",
											gap: "4px",
											opacity: activeCategoryId === cat.id ? 1 : .4
										},
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											onClick: (e) => {
												e.stopPropagation();
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
												...
												stroke: "currentColor",
												strokeWidth: "2.5",
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M3 6h18M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2M10 11v6M14 11v6" })
											})
										})]
									})]
								}, cat.id))
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
							...
							children: activeCategory ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								style: {
									display: "flex",
									flexDirection: "column",
									height: "100%",
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
										...
										children: ["التصنيفات الفرعية لـ ", activeCategory.name]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										style: {
											margin: 0,
											fontSize: "13px",
										...
										children: "إدارة الفروع التابعة لهذا التصنيف الرئيسي."
									})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: filteredSubCategories.map((sub) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											style: {
												padding: "16px 20px",
												background: "#f8fafc",
												borderRadius: "12px",
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												...
												onClick: () => {
													if (confirm("حذف الفرع؟")) deleteSubCategory(sub.id);
												},
												style: {
													color: "#ef4444",
													background: "#fee2e2",
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											...
											style: { fontSize: "15px" },
											children: "لا توجد تصنيفات فرعية مرتبطة بهذا القسم."
										})]
									})]
								})]
							}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										children: "اختر تصنيفاً رئيسياً من القائمة الجانبية لإدارة أقسامه الفرعية."
									})
								]
							})
						})
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									...
									children: "إدارة العلامات التجارية المسجلة في النظام."
								})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									style: {
										background: "#eff6ff",
										color: "#3b82f6",
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
									...
									placeholder: "أدخل اسم ماركة جديدة هنا...",
									style: {
										...inputStyle,
										padding: "14px"
									},
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: brands.map((brand) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									style: {
										background: "white",
										padding: "16px",
										borderRadius: "12px",
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: editingBrandId === brand.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
									...
									}), !editingBrandId && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										style: {
											display: "flex",
											gap: "4px"
										},
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											...
											onClick: () => {
												if (confirm("هل تريد حذف الماركة؟")) deleteBrand(brand.id);
											},
											style: {
												background: "#fee2e2",
												color: "#ef4444",
							...
							}), brands.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								style: {
									padding: "60px",
									textAlign: "center",
									color: "#94a3b8"
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									style: { fontSize: "48px" },
									children: "🏷️"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "لا توجد ماركات مسجلة حالياً." })]
							})]
						})]
					})
				})
...
//#endregion
//#region src/renderer/pages/Brands.tsx
function Brands() {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					children: [brands.length, " ماركة تجارية"]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				style: {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
					...
					}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tbody", { children: [brands.map((brand) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
						style: {
							borderBottom: "1px solid #f1f5f9",
							transition: "background 0.2s"
						},
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							...
							children: editingId === brand.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
								onSubmit: handleUpdateBrand,
								style: {
									display: "flex",
									gap: "8px"
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									onClick: () => {
										if (confirm("هل أنت متأكد من حذف هذه الماركة؟")) deleteBrand(brand.id);
									},
									style: {
										color: "#ef4444",
										background: "none",
					...
					}, brand.id)), brands.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
						colSpan: 2,
						style: {
							padding: "40px",
							textAlign: "center",
...
//#endregion
//#region src/renderer/services/users.service.ts
var usersService = {
	getAll: async () => {
...
//#endregion
//#region src/renderer/hooks/useUsers.ts
function useUsers() {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						children: loading ? "جاري الإضافة..." : "إضافة مستخدم"
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
					...
					}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: loading && users.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
						colSpan: 3,
						style: {
							padding: "32px",
							textAlign: "center",
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									children: u.role === "admin" ? "مدير" : "مستخدم"
								})
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								style: { padding: "16px" },
...
//#endregion
//#region src/renderer/services/invoices.service.ts
var invoicesService = {
	getAll: async () => {
...
//#endregion
//#region src/renderer/hooks/useInvoices.ts
...
//#endregion
//#region src/renderer/hooks/useCustomers.ts
function useCustomers() {
	const [customers, setCustomers] = (0, import_react.useState)([]);
	const [loading, setLoading] = (0, import_react.useState)(true);
	const fetchCustomers = (0, import_react.useCallback)(async () => {
		try {
			setLoading(true);
...
//#endregion
//#region src/renderer/pages/POS.tsx
function POS() {
	...
	const [showCustomerDropdown, setShowCustomerDropdown] = (0, import_react.useState)(false);
	const [totalDiscount, setTotalDiscount] = (0, import_react.useState)(0);
	const [paidAmount, setPaidAmount] = (0, import_react.useState)("");
	...
	const [selectedCartIndex, setSelectedCartIndex] = (0, import_react.useState)(null);
	const searchRef = (0, import_react.useRef)(null);
	const paidAmountRef = (0, import_react.useRef)(null);
	const selectedCustomer = (0, import_react.useMemo)(() => customers.find((c) => c.id === selectedCustomerId), [customers, selectedCustomerId]);
	const subtotal = cart.reduce((sum, item) => sum + item.price * item.quantity, 0);
	const total = Math.max(0, subtotal - totalDiscount);
	const change = typeof paidAmount === "number" ? Math.max(0, paidAmount - total) : 0;
	const totalQty = cart.reduce((sum, item) => sum + item.quantity, 0);
	const filteredProducts = (0, import_react.useMemo)(() => products.filter((p) => {
	...
	const filteredCustomers = (0, import_react.useMemo)(() => customers.filter((c) => c.name.toLowerCase().includes(customerSearch.toLowerCase()) || c.phone?.includes(customerSearch)), [customers, customerSearch]);
	const addToCart = (product) => {
		if (product.stock === 0) return;
		const existingIndex = cart.findIndex((item) => item.id === product.id);
		if (existingIndex !== -1) {
			setCart(cart.map((item, idx) => idx === existingIndex ? {
				...item,
	...
	const checkout = (0, import_react.useCallback)(async () => {
		...
		try {
			const result = await createInvoice({
				...
				customerId: selectedCustomerId || void 0,
				items: cart.map((item) => ({
					id: item.id,
					name: item.name,
					price: item.price,
	...
	(0, import_react.useEffect)(() => {
		const handleKey = (e) => {
			...
			if (e.key === "F4") {
				e.preventDefault();
				const targetInput = document.querySelector(`.qty-input[data-index="${selectedCartIndex}"]`);
				if (targetInput) {
					targetInput.focus();
					targetInput.select();
				}
			...
			if (cart.length > 0) {
				...
				if (e.key === "Delete" && selectedCartIndex !== null && document.activeElement?.tagName !== "INPUT") removeFromCart(cart[selectedCartIndex].id);
			}
		};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      ...
      ` }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
						...
						}), showCustomerDropdown && customerSearch && !selectedCustomerId && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								position: "absolute",
								top: "100%",
								left: 0,
							...
							className: "pos-scroll anim-slide",
							children: [filteredCustomers.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								onMouseDown: () => {
							...
							}, c.id)), filteredCustomers.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								style: {
									padding: "12px",
									textAlign: "center",
									color: "#94a3b8",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: ["فاتورة: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							style: {
								color: "#1e293b",
								fontWeight: "700"
							},
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							className: `cat-tab ${selectedCategoryId === null ? "active" : ""}`,
							style: {
								padding: "5px 12px",
								borderRadius: "8px",
								border: "none",
							...
							className: `cat-tab ${selectedCategoryId === cat.id ? "active" : ""}`,
							style: {
								padding: "5px 12px",
								borderRadius: "8px",
								border: "none",
						...
						children: productsLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								width: "100%",
								textAlign: "center",
								padding: "80px",
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								onClick: () => addToCart(p),
								className: `pos-card${isOOS ? " disabled" : ""}`,
								title: isOOS ? "المخزون نافد" : void 0,
								style: {
									background: "white",
									borderRadius: "6px",
									border: "1.5px solid #e2e8f0",
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: selectedCustomer ? selectedCustomer.name : "عميل نقدي"
								}), totalQty > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									style: {
										fontSize: "11px",
										color: "#94a3b8",
										background: "#f1f5f9",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: cart.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: cart.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									style: {
										...
										background: "#f8fafc",
										borderRadius: "8px",
										border: index === selectedCartIndex ? `2px solid ${P}` : "1px solid #e8f0fe",
										cursor: "pointer",
										boxShadow: index === selectedCartIndex ? "0 0 0 2px rgba(37,99,235,0.1)" : "none"
									},
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											style: {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: [
										...
										"transfer",
										"credit"
									].map((pm) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										onClick: () => setPaymentMethod(pm),
										className: `pay-btn ${paymentMethod === pm ? "active" : ""}`,
										style: {
											flex: 1,
											padding: "6px 2px",
											borderRadius: "7px",
										...
										children: pm === "cash" ? "💵 نقدي" : pm === "card" ? "💳 بطاقة" : pm === "transfer" ? "🏦 تحويل" : "⏳ آجل"
									}, pm))
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									style: {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											style: {
												fontSize: "16px",
												fontWeight: "700",
												color: change > 0 ? "#16a34a" : "#94a3b8",
												padding: "1px 6px",
												background: change > 0 ? "#f0fdf4" : "#f8fafc",
												borderRadius: "9px",
												border: `2px solid ${change > 0 ? "#bbf7d0" : "#e2e8f0"}`
											},
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									style: {
										...
										borderRadius: "11px",
										border: "none",
										background: cart.length === 0 ? "#e2e8f0" : SUCCESS,
									...
									onMouseOver: (e) => {
										if (cart.length > 0) e.currentTarget.style.background = "#15803d";
									},
									onMouseOut: (e) => {
										if (cart.length > 0) e.currentTarget.style.background = SUCCESS;
									},
									children: isCheckingOut ? "⏳ جاري الحفظ..." : "✅ إتمام البيع  [F9]"
								})
							]
						})
					]
			...
			successInfo && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "anim-fade",
				style: {
					position: "fixed",
					inset: 0,
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: ["رقم الفاتورة: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								style: {
									color: "#0f172a",
									fontWeight: "800"
								},
								children: successInfo.number
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
...
//#endregion
//#region src/renderer/pages/Login.tsx
function Login() {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "يرجى إدخال بياناتك للدخول إلى لوحة التحكم"
						})
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { children: "اسم المستخدم" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								type: "text",
								value: username,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "input-group",
							style: { marginBottom: "24px" },
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { children: "كلمة المرور" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							disabled: isLoading,
							children: isLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "spinner" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "جاري التحميل..." })] }) : "تسجيل الدخول"
						})
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: ["جميع الحقوق محفوظة © ", (/* @__PURE__ */ new Date()).getFullYear()]
				})
			]
		})]
	});
...
//#endregion
//#region src/renderer/pages/Customers.tsx
function Customers() {
	...
	const handleDelete = async (id) => {
		if (confirm("هل أنت متأكد من حذف هذا العميل؟")) await deleteCustomer(id);
	};
	const handleSubmit = async (e) => {
		e.preventDefault();
		try {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "+" }), "عميل جديد"]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				style: { marginBottom: "20px" },
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
					...
					}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tbody", { children: [filteredCustomers.map((customer) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
						style: {
							borderBottom: "1px solid #f1f5f9",
							transition: "background 0.2s"
						},
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								style: {
									padding: "15px",
									color: customer.totalDebt && customer.totalDebt > 0 ? "#e53e3e" : "#48bb78",
									fontWeight: "bold"
								},
								children: customer.totalDebt?.toFixed(2) || "0.00"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								style: {
									padding: "15px",
								...
								children: customer.loyaltyPoints || 0
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
								style: {
									padding: "15px",
						...
						children: "لا يوجد عملاء مطابقين للبحث"
					}) })] })]
				})
			}),
			showModal && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						...
						children: editingCustomer ? "تعديل بيانات عميل" : "إضافة عميل جديد"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
						onSubmit: handleSubmit,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
									...
									children: "الرصيد الافتتاحي (مدين)"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
									type: "number",
									step: "0.01",
									...
									onChange: (e) => setFormData({
										...formData,
										totalDebt: parseFloat(e.target.value)
									}),
									style: {
										width: "100%",
										padding: "10px",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
									...
									onChange: (e) => setFormData({
										...formData,
										loyaltyPoints: parseInt(e.target.value)
									}),
									style: {
										width: "100%",
										padding: "10px",
...
//#endregion
//#region src/renderer/hooks/useSuppliers.ts
function useSuppliers() {
	const [suppliers, setSuppliers] = (0, import_react.useState)([]);
	const [loading, setLoading] = (0, import_react.useState)(true);
	const fetchSuppliers = (0, import_react.useCallback)(async () => {
		try {
			setLoading(true);
	...
	const updateSupplier = async (id, payload) => {
		const result = await window.api.suppliers.update({
			id,
			...payload
		});
		await fetchSuppliers();
...
//#endregion
//#region src/renderer/pages/Suppliers.tsx
function Suppliers() {
	...
	const handleDelete = async (id) => {
		if (confirm("هل أنت متأكد من حذف هذا المورد؟")) await deleteSupplier(id);
	};
	const handleSubmit = async (e) => {
		e.preventDefault();
		try {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "+" }), "مورد جديد"]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				style: { marginBottom: "20px" },
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
					...
					}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tbody", { children: [filteredSuppliers.map((supplier) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
						style: {
							borderBottom: "1px solid #f1f5f9",
							transition: "background 0.2s"
						},
					...
					}, supplier.id)), filteredSuppliers.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
						colSpan: 5,
						style: {
							padding: "40px",
							textAlign: "center",
						...
						children: "لا يوجد موردين مطابقين للبحث"
					}) })] })]
				})
			}),
			showModal && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						...
						children: editingSupplier ? "تعديل بيانات مورد" : "إضافة مورد جديد"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
						onSubmit: handleSubmit,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
									...
									children: "جهة الاتصال (الموظف مسؤول)"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
									type: "text",
...
//#endregion
//#region src/renderer/services/returns.service.ts
var returnsService = {
	create: async (payload) => {
	...
	getReturnableInvoiceItems: async (invoiceId) => {
		return await window.api.returns.getReturnableInvoiceItems(invoiceId);
	}
};
//#endregion
//#region src/renderer/hooks/useReturns.ts
function useReturns() {
	const [loading, setLoading] = (0, import_react.useState)(false);
	const [error, setError] = (0, import_react.useState)(null);
	return {
		loading,
		error,
		createReturn: (0, import_react.useCallback)(async (payload) => {
			setLoading(true);
			setError(null);
			try {
				return await returnsService.create(payload);
			} catch (err) {
		...
		getAllReturns: (0, import_react.useCallback)(async (filters) => {
			setLoading(true);
			setError(null);
			try {
		...
		getReturnDetails: (0, import_react.useCallback)(async (id) => {
			setLoading(true);
			setError(null);
			try {
		...
		getReturnableItems: (0, import_react.useCallback)(async (invoiceId) => {
			setLoading(true);
			setError(null);
			try {
...
//#endregion
//#region src/renderer/pages/Invoices.tsx
function Invoices() {
	...
	const [invoiceReturns, setInvoiceReturns] = (0, import_react.useState)([]);
	...
	const handleShowDetails = async (id) => {
		try {
			setSelectedInvoice(await getInvoiceDetails(id));
			setInvoiceReturns(await window.api.returns.getByInvoice(id));
			setShowDetails(true);
	...
	const handleInitiateReturn = () => {
		setIsReturning(true);
		setReturnItems(selectedInvoice.items.map((it) => ({
			...it,
			returnQuantity: 0,
			refundAmount: 0
		})));
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					...
					children: "سجل الفواتير الاحترافي"
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				style: {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
						...
						children: "جاري التحميل..."
					}) }) : filteredInvoices.map((invoice) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								...
								children: new Date(invoice.date).toLocaleString("ar-EG")
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								style: {
									padding: "18px",
								...
								children: invoice.customerName || "عميل نقدي"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								style: { padding: "18px" },
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									style: {
										...
										fontSize: "12px",
										fontWeight: "bold",
										backgroundColor: invoice.status === "active" ? "#dcfce7" : invoice.status === "partially_returned" ? "#fef9c3" : "#fee2e2",
										color: invoice.status === "active" ? "#166534" : invoice.status === "partially_returned" ? "#854d0e" : "#991b1b"
									},
									children: invoice.status === "active" ? "نشطة" : invoice.status === "returned" ? "مرتجعة" : invoice.status === "partially_returned" ? "مرتجعة جزئياً" : "ملغاة"
								})
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								style: {
								...
								children: invoice.total.toFixed(2)
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								style: { padding: "18px" },
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			showDetails && selectedInvoice && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				style: {
					position: "fixed",
					top: 0,
					left: 0,
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
								style: { margin: 0 },
								children: ["تفاصيل فاتورة: ", selectedInvoice.invoiceNumber]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
										style: { padding: "12px" },
										children: "المتاح للإرجاع"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
										style: { padding: "12px" },
										children: "الإجمالي"
									}),
									isReturning && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
										style: { padding: "12px" },
										children: "إرجاع"
									})
								]
							}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: selectedInvoice.items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										style: { padding: "12px" },
										children: item.returnableQuantity
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										style: {
											padding: "12px",
									...
									isReturning && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										style: { padding: "12px" },
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
											type: "number",
											...
											onChange: (e) => {
												...
												setReturnItems((prev) => prev.map((p) => p.id === item.id ? {
													...p,
													returnQuantity: q,
													refundAmount: q * item.price
												} : p));
											}
										})
									})
						...
						invoiceReturns.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							style: {
								marginBottom: "15px",
								color: "#ef4444"
							},
							children: "سجل المرتجعات لهذه الفاتورة"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
							style: {
								width: "100%",
								borderCollapse: "collapse",
							...
							}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: invoiceReturns.map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
								style: { borderBottom: "1px solid #fff5f5" },
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										style: { padding: "12px" },
										children: new Date(r.date).toLocaleString("ar-EG")
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										style: { padding: "12px" },
										children: r.reason
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
										...
										children: [r.totalAmount.toFixed(2), " ر.س"]
									})
								]
							}, r.id)) })]
						})] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								!isReturning && selectedInvoice.status === "active" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									children: "تجهيز مرتجع"
								}),
								isReturning && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
...
//#endregion
//#region src/renderer/pages/Invoices/ReturnsPage.tsx
function ReturnsPage() {
	...
	const [searchTerm, setSearchTerm] = (0, import_react.useState)("");
	const [showNewReturnModal, setShowNewReturnModal] = (0, import_react.useState)(false);
	const [invoiceSearch, setInvoiceSearch] = (0, import_react.useState)("");
	const [foundInvoice, setFoundInvoice] = (0, import_react.useState)(null);
	const [returnItems, setReturnItems] = (0, import_react.useState)([]);
	const [selectedReturn, setSelectedReturn] = (0, import_react.useState)(null);
	const [showDetailsModal, setShowDetailsModal] = (0, import_react.useState)(false);
	...
	const loadReturns = async () => {
		try {
			...
			setReturns(data);
			const total = data.reduce((sum, r) => sum + r.totalRefunded, 0);
			setStats({
				totalCount: data.length,
				totalAmount: total,
				partialCount: data.filter((r) => r.status === "partially_returned").length
			});
		} catch (err) {
			console.error(err);
		}
	...
	const handleSearchInvoice = async () => {
		...
		try {
			...
			} else alert("لم يتم العثور على الفاتورة");
		} catch (err) {
	...
	const handleShowDetails = async (id) => {
		try {
			setSelectedReturn(await getReturnDetails(id));
			setShowDetailsModal(true);
		} catch (err) {
			alert("خطأ في تحميل التفاصيل");
		}
	};
	const filteredReturns = returns.filter((r) => r.returnNumber.toLowerCase().includes(searchTerm.toLowerCase()) || r.invoiceNumber.toLowerCase().includes(searchTerm.toLowerCase()) || r.customerName && r.customerName.toLowerCase().includes(searchTerm.toLowerCase()));
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		style: {
			padding: "24px",
			direction: "rtl",
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					...
					children: "إدارة المرتجعات"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					style: {
						margin: "4px 0 0",
						color: "#64748b"
					},
					children: "عرض ومعالجة مرتجعات المبيعات والتحكم في المخزون"
				})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: "إجمالي عمليات المرتجع"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							style: {
								fontSize: "24px",
								fontWeight: "800",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: [stats.totalAmount.toLocaleString("ar-EG"), " ر.س"]
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						style: {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: returns.filter((r) => new Date(r.date).toDateString() === (/* @__PURE__ */ new Date()).toDateString()).length
						})]
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
					...
					}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: loading && returns.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
						colSpan: 7,
						style: {
							padding: "48px",
							textAlign: "center",
						...
						children: "جاري التحميل..."
					}) }) : filteredReturns.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
						colSpan: 7,
						style: {
							padding: "48px",
							textAlign: "center",
					...
					}) }) : filteredReturns.map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
						style: { borderBottom: "1px solid #f1f5f9" },
						className: "hover-row",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								...
								children: new Date(r.date).toLocaleDateString("ar-EG")
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
								style: {
									padding: "16px",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								style: { padding: "16px" },
								children: r.customerName || "عميل نقدي"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								style: {
									padding: "16px",
								...
								children: r.totalRefunded.toFixed(2)
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								style: { padding: "16px" },
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			showNewReturnModal && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				style: {
					position: "fixed",
					top: 0,
					left: 0,
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: !foundInvoice ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								style: {
									textAlign: "center",
									padding: "40px 0"
								},
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									children: "أدخل رقم الفاتورة للبدء في عملية الإرجاع"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									style: {
										display: "flex",
										gap: "10px",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: foundInvoice.invoiceNumber
										})] }),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											style: {
												fontSize: "12px",
											...
											style: { fontWeight: "800" },
											children: foundInvoice.customerName || "عميل نقدي"
										})] }),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									...
									children: "الأصناف القابلة للإرجاع"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
									style: {
										width: "100%",
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
												style: { padding: "12px 8px" },
												children: "الكمية للإرجاع"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
												style: { padding: "12px 8px" },
												children: "قيمة المسترد"
											})
										]
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
													...
													children: ["سعر البيع: ", item.price.toFixed(2)]
												})]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												style: { padding: "12px 8px" },
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												...
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [
														/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
															onClick: () => setReturnItems((prev) => prev.map((p, i) => i === idx ? {
																...p,
																returnQty: Math.max(0, p.returnQty - 1)
															} : p)),
															style: {
																width: "28px",
																height: "28px",
														...
														/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
															...
															children: item.returnQty
														}),
														/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
															onClick: () => setReturnItems((prev) => prev.map((p, i) => i === idx ? {
																...p,
																returnQty: Math.min(p.returnableQuantity, p.returnQty + 1)
															} : p)),
															style: {
																width: "28px",
																height: "28px",
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												...
												children: (item.price * item.returnQty).toFixed(2)
											})
										]
									}, item.id)) })]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: [returnItems.reduce((s, it) => s + it.price * it.returnQty, 0).toFixed(2), " ر.س"]
									})]
								})
							] })
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								...
								style: {
									...
									fontWeight: "700",
									cursor: "pointer",
									opacity: !foundInvoice || returnItems.every((i) => i.returnQty === 0) || loading ? .5 : 1
								},
								children: loading ? "جاري المعالجة..." : "تأكيد وإتمام المرتجع"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								onClick: () => setShowNewReturnModal(false),
								style: {
									flex: 1,
			...
			showDetailsModal && selectedReturn && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				style: {
					position: "fixed",
					top: 0,
					left: 0,
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
								style: { margin: 0 },
								children: ["تفاصيل مرتجع ", selectedReturn.returnNumber]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: "سبب المرتجع:"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								style: { fontWeight: "600" },
								children: selectedReturn.reason || "غير محدد"
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
							style: {
							...
							}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: selectedReturn.items.map((it) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
								style: { borderBottom: "1px solid #f8fafc" },
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										style: { padding: "8px" },
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										style: { padding: "8px" },
										children: it.unitPrice.toFixed(2)
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										style: {
											padding: "8px",
										...
										children: it.lineTotal.toFixed(2)
									})
								]
							}, it.id)) })]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: [selectedReturn.totalRefunded.toFixed(2), " ر.س"]
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							onClick: () => setShowDetailsModal(false),
...
//#endregion
//#region src/renderer/components/Sidebar.tsx
var Icon = ({ name }) => {
	switch (name) {
		case "home": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
			...
			strokeLinecap: "round",
			strokeLinejoin: "round",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("polyline", { points: "9 22 9 12 15 12 15 22" })]
		});
		case "pos": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
			width: "20",
			height: "20",
			fill: "none",
			stroke: "currentColor",
		...
		case "invoices": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
			width: "20",
			height: "20",
			fill: "none",
			stroke: "currentColor",
			...
			strokeLinejoin: "round",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1-2-1Z" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M14 8H6" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M14 12H6" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M10 16H6" })
			]
		});
		case "returns": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
			width: "20",
			height: "20",
			fill: "none",
			stroke: "currentColor",
			...
			strokeLinecap: "round",
			strokeLinejoin: "round",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M9 14 4 9l5-5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M4 9h10.5a5.5 5.5 0 0 1 5.5 5.5v0a5.5 5.5 0 0 1-5.5 5.5H11" })]
		});
		case "products": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
			width: "20",
			height: "20",
			fill: "none",
			stroke: "currentColor",
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "m3.27 6.96 8.73 5.05 8.73-5.05" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M12 22.08V12" })
			]
		});
		case "categories": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
			width: "20",
			height: "20",
			fill: "none",
			stroke: "currentColor",
			...
			strokeLinecap: "round",
			strokeLinejoin: "round",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" })
		});
		case "brands": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
			width: "20",
			height: "20",
			fill: "none",
			stroke: "currentColor",
			...
			strokeLinecap: "round",
			strokeLinejoin: "round",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M12 2H2v10l9.29 9.29c.94.94 2.48.94 3.42 0l5.58-5.58c.94-.94.94-2.48 0-3.42L12 2Z" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M7 7h.01" })]
		});
		case "purchases": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
			width: "20",
			height: "20",
			fill: "none",
			stroke: "currentColor",
		...
		case "inventory": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
			width: "20",
			height: "20",
			fill: "none",
			stroke: "currentColor",
		...
		case "customers": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
			width: "20",
			height: "20",
			fill: "none",
			stroke: "currentColor",
		...
		case "suppliers": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
			width: "20",
			height: "20",
			fill: "none",
			stroke: "currentColor",
		...
		case "users": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
			width: "20",
			height: "20",
			fill: "none",
			stroke: "currentColor",
			...
			strokeLinecap: "round",
			strokeLinejoin: "round",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", {
				cx: "12",
				cy: "7",
				r: "4"
			})]
		});
		case "permissions": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
			width: "20",
			height: "20",
			fill: "none",
			stroke: "currentColor",
		...
		case "reports": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
			width: "20",
			height: "20",
			fill: "none",
			stroke: "currentColor",
		...
		case "settings": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
			width: "20",
			height: "20",
			fill: "none",
			stroke: "currentColor",
			...
			strokeLinecap: "round",
			strokeLinejoin: "round",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.72V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.17a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.1a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", {
				cx: "12",
				cy: "12",
				r: "3"
			})]
      ...
      ` }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					...
					style: { marginBottom: "10px" },
					children: [!isCollapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "group-header",
						children: group.title
					}), group.items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(NavLink, {
						to: item.path,
...
//#endregion
//#region src/renderer/pages/ComingSoon.tsx
function ComingSoon({ title }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				style: { fontSize: "16px" },
				children: "هذه الصفحة قيد التطوير حالياً وستكون متاحة قريباً."
			})
		]
	});
}
//#endregion
//#region src/renderer/components/SectionLayout.tsx
function SectionLayout({ title, tabs }) {
	useLocation();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		style: {
			display: "flex",
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [title && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: tabs.map((tab) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NavLink, {
						to: tab.path,
...
//#endregion
//#region src/renderer/pages/Inventory/InventoryPage.tsx
var inventoryTabs = [
	{
		label: "المنتجات",
		path: ""
...
function InventoryPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLayout, { tabs: inventoryTabs });
}
//#endregion
//#region src/renderer/pages/Parties/PartiesPage.tsx
var partiesTabs = [{
	label: "العملاء",
	path: ""
}, {
...
function PartiesPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLayout, {
		title: "إدارة الأطراف",
		tabs: partiesTabs
	});
}
//#endregion
//#region src/renderer/pages/Invoices/InvoicesPage.tsx
var invoiceTabs = [{
	label: "فواتير البيع",
	path: ""
}, {
...
//#endregion
//#region src/renderer/pages/Admin/AdminPage.tsx
var adminTabs = [
	{
		label: "المستخدمون",
		path: ""
...
//#endregion
//#region src/renderer/pages/Admin/SettingsPage.tsx
function SettingsPage() {
	const { units, createUnit, deleteUnit, loading } = useUnits();
	const [newUnitName, setNewUnitName] = (0, import_react.useState)("");
	const [newUnitShortName, setNewUnitShortName] = (0, import_react.useState)("");
	const handleAddUnit = async (e) => {
		e.preventDefault();
		if (!newUnitName.trim()) return;
		try {
			await createUnit(newUnitName.trim(), newUnitShortName.trim() || void 0);
			setNewUnitName("");
			setNewUnitShortName("");
		} catch (err) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				style: { color: "#64748b" },
				children: "تخصيص الإعدادات العامة والوحدات."
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			style: {
				display: "grid",
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "📏" }), " إدارة الوحدات"]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "جاري التحميل..." }) : units.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							style: {
								color: "#94a3b8",
								gridColumn: "1/-1"
							},
							children: "لا توجد وحدات مضافة بعد."
						}) : units.map((unit) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								background: "#f8fafc",
								padding: "12px",
								borderRadius: "10px",
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								style: { fontWeight: "bold" },
								children: unit.name
							}), unit.shortName && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								style: {
									fontSize: "12px",
									color: "#64748b",
									marginRight: "4px"
								...
								onClick: () => {
									if (confirm("حذف هذه الوحدة؟")) deleteUnit(unit.id);
								},
								style: {
									background: "none",
									border: "none",
...
function App() {
	...
	if (!user) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Login, {});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		style: {
			display: "flex",
			height: "100vh",
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sidebar, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Routes, { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
					path: "/",
					element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(POS, {})
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
					path: "/dashboard",
					element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ComingSoon, { title: "الرئيسية" })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Route, {
					path: "/inventory",
					element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InventoryPage, {}),
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
							index: true,
							element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Products_default, {})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
							path: "categories",
							element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CategoriesAndBrands, {})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
							path: "brands",
							element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Brands, {})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
							path: "purchases",
							element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ComingSoon, { title: "المشتريات" })
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
							path: "audit",
							element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ComingSoon, { title: "الجرد" })
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
							path: "movements",
							element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ComingSoon, { title: "حركات المخزون" })
						})
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Route, {
					path: "/invoices",
					element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InvoicesPage, {}),
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
							index: true,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
							path: "returns",
							element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReturnsPage, {})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
							path: "pending",
							element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ComingSoon, { title: "الفواتير المعلقة" })
						})
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Route, {
					path: "/parties",
					element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PartiesPage, {}),
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
						index: true,
						element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Customers, {})
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
						path: "suppliers",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Route, {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
							path: "permissions",
							element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ComingSoon, { title: "الصلاحيات" })
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
							path: "settings",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
					path: "/reports",
					element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ComingSoon, { title: "التقارير" })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
					path: "/settings",
					element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SettingsPage, {})
...
(0, import_client.createRoot)(document.getElementById("root")).render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HashRouter, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(App, {}) }) }) }));
//#endregion
